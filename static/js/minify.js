...
class Scene{
    ...
    init(t,i)
    {
        ...
        buildGeometry(t)
        {
            ...
            const s=[+!+[]+!+[]]+[+[]]+[+[]]|0,h=~~(s*this.height/this.width),
            ...
            return Object.values(t).forEach(t=>
                {
                    ...
                    for(let t=0,i=e.width*e.height;t<i;t++)
                        e.data[4*t+3]&&n.push({x:t%e.width/e.width,y:t/e.width/e.height});
            ...
            renderParticles()
            {
                this.particles.forEach(t=>{const i=t.getAxis2D();
        ...
        function reset(){
            ...
            ctx.scale(t,t),scene&&scene.init(canvasWidth,canvasHeight),
